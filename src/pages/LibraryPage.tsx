    ...
    return (
        <div className={`${cardBg} rounded-lg overflow-hidden border shadow-lg flex flex-col`}>
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-md my-1" style={{ color: siteConfig.primaryColor }}>{book.author}</p>
...
const LibraryPage: React.FC = () => {
  ...
  return (
    <div>
      <h1 className={`text-4xl font-bold mb-8 pb-4 border-b-2 ${borderColor}`} style={{ color: siteConfig.primaryColor }}>المكتبة الرقمية</h1>
