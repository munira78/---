...
const AboutPage: React.FC = () => {
  ...
  return (
    <div>
      <h1 className={`text-4xl font-bold text-amber-400 mb-8 pb-4 border-b-2 ${borderColor}`}>نبذة عن القسم</h1>
      <div className={`space-y-6 text-lg ${textColor} leading-relaxed`}>
        ...
        <div className={`${cardBgColor} p-6 rounded-lg border ${borderColor}`}>
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">رؤيتنا</h2>
            <p>
        ...
        <div className={`${cardBgColor} p-6 rounded-lg border ${borderColor}`}>
            <h2 className="text-2xl font-semibold text-blue-400 mb-3">رسالتنا</h2>
            <p>
        ...
        <div>
            <h2 className="text-2xl font-semibold text-blue-400 mb-4">أهدافنا</h2>
